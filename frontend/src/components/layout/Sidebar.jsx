      ...
      <div className="flex items-center justify-between px-4 h-16 shrink-0" style={{ borderBottom: "1px solid var(--border-color-subtle)" }}>
        {!collapsed && (
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="text-sm font-bold" style={{ color: "var(--text-primary)" }}>MedResearch</span>
              <span className="text-[10px] block font-medium uppercase tracking-widest" style={{ color: "var(--brand-primary)" }}>AI</span>
            </div>
          </div>
        )}
        {collapsed && (
