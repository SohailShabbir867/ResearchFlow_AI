...
export default function Research() {
  ...
  useEffect(() => {
    if (currentChatId) {
      dispatch(loadChat(currentChatId));
    }
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      {/* ── Sidebar ── */}
      <aside className={`
        bg-gray-900 text-gray-100 flex flex-col shrink-0 border-r border-gray-800
          ...
          {chatList.length === 0 ? (
            ...
            chatList.map((c) => {
              ...
              return (
                <div
                  key={c._id}
                  onClick={() => dispatch(loadChat(c._id))}
                  className={`
                ...
                >
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 hover:text-red-400
                               p-1 rounded transition-opacity shrink-0 ml-1"
                    title="Delete chat"
                  >
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-100 px-6 py-4 shadow-sm z-10 shrink-0">
          <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    ...
                    <p className="text-[10px] text-gray-400 font-semibold tracking-wide uppercase">
                      FastEmbed · Qdrant · Groq LLaMA 70B · Hybrid Search
                    </p>
                  </div>
                </div>
              </div>
            ...
            <span className="text-xs text-gray-400 font-medium bg-gray-50
